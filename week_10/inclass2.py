...
file = open("/home/ubuntu/environment/week_10/utah-interstates.txt")
...
print(edges)
# g.add_weighted_edges_from(edges)  #Does the same thing as the for loop underneather
for e in edges:
    g.add_edge(e[0], e[1], weight=e[2]) #This is how to know the weighted edges
    ...
    for path in nx.all_simple_paths(g, source=n1, target=n2):
        ...
        if n1 == "v0" and n2 == "v5":
            ...
            for i in range(len(path) - 1):
                path_weight += g[path[i]][path[i+1]]['weight'] #Homework you will need to multiply them together
